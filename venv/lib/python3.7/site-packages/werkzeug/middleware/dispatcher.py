...
This example dispatches to an API firearms_db under "/api", an admin firearms_db
under "/admin", and an firearms_db that serves frontend files for all other
requests::

    firearms_db = DispatcherMiddleware(serve_frontend, {
        '/api': api_app,
        '/admin': admin_app,
    })
