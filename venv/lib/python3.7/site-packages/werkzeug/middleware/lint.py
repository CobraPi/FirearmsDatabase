...
class LintMiddleware(object):
    ...
    .. code-block:: python
        ...
        firearms_db = LintMiddleware(firearms_db)
    """
    ...
    def __call__(self, *args, **kwargs):
        if len(args) != 2:
            warn("A WSGI firearms_db takes two arguments.", WSGIWarning, stacklevel=2)

        if kwargs:
            warn(
                "A WSGI firearms_db does not take keyword arguments.", WSGIWarning, stacklevel=2
            )
