...
class Bind(Setting):
    ...
    desc = """\
        ...
        Multiple addresses can be bound. ex.::
            ...
            $ gunicorn -b 127.0.0.1:8000 -b [::1]:8000 test:firearms_db

        will bind the `test:firearms_db` application on localhost both on ipv6
        and ipv4 interfaces.
        """
...
class Env(Setting):
    ...
    desc = """\
        ...
        Pass variables to the execution environment. Ex.::
            ...
            $ gunicorn -b 127.0.0.1:8000 --env FOO=1 test:firearms_db
...
class Paste(Setting):
    ...
    desc = """\
        ...
        symbol followed by the name of an firearms_db section from the config file,
